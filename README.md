...
- You can import your own data into Colab notebooks from your Google Drive account, hence including from spreadsheets, as well as from Github and many other sources. To learn more about importing data, and also how Colab can be used for data science, see the links below under Working with Data.
